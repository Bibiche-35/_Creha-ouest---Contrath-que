...
<form action="index.php?action=modifierConvention&amp;siret=<?= $_GET['siret'] ?>&amp;id_conv=<?= $_GET['id_conv'] ?>" method="post">
    <div>
        <h3>
            <p>Siret du client : <?= $_GET['siret'] ?> - Id Convention : <?= $_GET['id_conv'] ?></p>
        </h3>
        ...
        <label for="commentaire_conv">Commentaire libre sur convention : </label><input id="commentaire_conv" type="text" name="commentaire_conv" value="<?= $postConventionClient['comment_conv'] ?>"></br>
    ...
    <div>
        <label for="auteur_conv">Auteur : </label><input id="auteur_conv" type="text" name="auteur_conv"></br>
        <label for="statut_conv">Statut : </label><input id="statut_conv" type="text" name="statut_conv"></br>
        <label for="commentaire_conv">Commentaire : </label><input id="commentaire_conv" type="text" name="commentaire_conv"></br>
    </div></br>
    <div>
